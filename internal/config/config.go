...
func init() {
	...
	flag.StringVar(&Opts.Spec.Identity.Os.Serial, "identity.os.serial", Opts.Spec.Identity.Os.Serial, "")
	...
	flag.StringVar(&Opts.Spec.Store.MongoDB.Uri, "store.mongodb.uri", "", "")
	flag.StringVar(&Opts.Spec.Store.MongoDB.Host, "store.mongodb.host", "", "")
	flag.IntVar(&Opts.Spec.Store.MongoDB.Port, "store.mongodb.port", 27017, "")
	flag.StringVar(&Opts.Spec.Store.InfluxDB.Protocol, "store.influxdb.protocol", "http", "")
	flag.StringVar(&Opts.Spec.Store.InfluxDB.Host, "store.influxdb.host", Opts.Spec.Store.InfluxDB.Host, "")
